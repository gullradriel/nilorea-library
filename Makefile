...
ifeq ($(OS),Windows_NT)
    ...
    RM=rm -f
    CC= gcc
    # -luser32 backs n_clipboard's Win32 clipboard (OpenClipboard/GetClipboardData/...)
    CLIBS= -pthread -lws2_32 -lm -ldbghelp -luser32
    DEBUGLIB=-limagehlp
    ...
    ifeq ($(UNAME_S),Linux)
        ...
        # -lX11 backs n_clipboard's X11 selection owner (CLIPBOARD + PRIMARY)
        CLIBS=-lpthread -lm -lX11
...
TEST_FILES= test_allegro5.c test_kafka.c test_openssl.c test_cjson.c test_pcre.c test_pcre_const.c test_libgit2.c test_http3.c
...
# HTTP/3 (n_http3): opt-in, auto-detected. The client is built on ngtcp2 (QUIC),
# nghttp3 (HTTP/3 + QPACK) and the OpenSSL native QUIC handshake, all located via
# pkg-config. When the stack is absent (e.g. a minimal MSYS2 without the
# mingw-w64 ngtcp2/nghttp3 packages) HAVE_HTTP3 stays 0 and src/n_http3.c compiles
# as the not-available stub, so the default build never requires the extra libs
# and stays cross-compilable.
HTTP3_CFLAGS=$(shell pkg-config --cflags libngtcp2 libngtcp2_crypto_ossl libnghttp3 2>/dev/null)
HTTP3_CLIBS=$(shell pkg-config --libs libngtcp2 libngtcp2_crypto_ossl libnghttp3 2>/dev/null) -lssl -lcrypto
ifeq "$(shell pkg-config --exists libngtcp2 libngtcp2_crypto_ossl libnghttp3 2>/dev/null && $(CC) $(CFLAGS) $(HTTP3_CFLAGS) test_http3.c -Wall -o $(TMP_OBJ) $(HTTP3_CLIBS) 1>/dev/null 2>/dev/null && echo $$? )" "0"
    HAVE_HTTP3=1
    CFLAGS += -DHAVE_HTTP3 $(HTTP3_CFLAGS)
else
    HAVE_HTTP3=0
    HTTP3_CFLAGS=
    HTTP3_CLIBS=
...
EXAMPLES=examples/ex_base64_encode$(EXT) $\
         ...
         examples/ex_network_connect_abort$(EXT) $\
         examples/ex_network_proxy$(EXT) $\
         examples/ex_url$(EXT) $\
         examples/ex_html$(EXT) $\
         examples/ex_hex$(EXT) $\
         examples/ex_random$(EXT) $\
         examples/ex_entropy$(EXT) $\
         examples/ex_cookies$(EXT) $\
         examples/ex_http2$(EXT) $\
         examples/ex_dns$(EXT) $\
         examples/ex_http3$(EXT)
...
ifeq ($(HAVE_ALLEGRO),1)
    ifeq ($(FORCE_NO_ALLEGRO),0)
        ...
        EXAMPLES+= examples/ex_gui_particles$(EXT) $\
                  ...
                  examples/ex_gui_layout_persist$(EXT) $\
                  examples/ex_gui_datagrid$(EXT) $\
                  examples/ex_gui_bench$(EXT) $\
                  examples/ex_gui_progressbar$(EXT) $\
                  examples/ex_gui_custom$(EXT) $\
                  examples/ex_gui_placeholder$(EXT) $\
                  examples/ex_gui_zorder$(EXT) $\
                  examples/ex_gui_multiwin$(EXT) $\
                  examples/ex_gui_detach$(EXT) $\
...
ifeq ($(HAVE_CJSON),1)
    ifeq ($(FORCE_NO_CJSON),0)
        ...
        SRC+= n_avro.c n_json.c
        OBJECTS+=obj/cJSON.o
        EXAMPLES+= examples/ex_avro$(EXT)
        EXAMPLES+= examples/ex_json$(EXT)
        EXAMPLES+= examples/ex_pretty$(EXT)
        ifeq ($(HAVE_ALLEGRO),1) 
            ifeq ($(FORCE_NO_ALLEGRO),0)
...
ifeq ($(HAVE_OPENSSL),1)
    ifeq ($(FORCE_NO_OPENSSL),0)
        ...
        EXAMPLES+= examples/ex_x509$(EXT)
        EXAMPLES+= examples/ex_digest$(EXT)
        EXAMPLES+= examples/ex_network_sni$(EXT)
...
ifeq ($(HAVE_PCRE),1)
    ifeq ($(FORCE_NO_PCRE),0)
        SRC+= n_pcre.c n_config_file.c n_query.c
        EXAMPLES+= examples/ex_pcre$(EXT) $\
                   examples/ex_query$(EXT) $\
...
show-detected-option:
	@echo "HAVE_ALLEGRO: $(HAVE_ALLEGRO), HAVE_KAFKA: $(HAVE_KAFKA), HAVE_OPENSSL: $(HAVE_OPENSSL), HAVE_CJSON: $(HAVE_CJSON), HAVE_PCRE: $(HAVE_PCRE), HAVE_PCRE_CONST: $(HAVE_PCRE_CONST), HAVE_LIBGIT2: $(HAVE_LIBGIT2), HAVE_HTTP3: $(HAVE_HTTP3), HAVE_REACTOR: $(HAVE_REACTOR)"
...
$(OUTPUT)$(LIB_DYN_EXT): $(OBJECTS)
	$(CC) $(LIB_LDFLAGS) -shared -o $(OUTPUT)$(LIB_DYN_EXT) $^ $(CLIBS) $(ALLEGRO_CLIBS) $(KAFKA_CLIBS) $(OPENSSL_CLIBS) $(PCRE_CLIBS) $(LIBGIT2_CLIBS) $(HTTP3_CLIBS)
...
examples/ex_x509$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_x509.o examples/ex_x509.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(OPENSSL_CLIBS) $(EXE_LDFLAGS)

examples/ex_digest$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hex.o obj/n_digest.o examples/ex_digest.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(OPENSSL_CLIBS) $(EXE_LDFLAGS)

examples/ex_network_sni$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_network_msg.o obj/n_time.o obj/n_thread_pool.o obj/n_network.o $(REACTOR_OBJ) obj/n_base64.o $(NZLIB_OBJS) obj/n_lz4.o obj/lz4.o obj/n_x509.o examples/ex_network_sni.o
...
examples/ex_clipboard$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_time.o obj/n_clipboard.o examples/ex_clipboard.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)
...
examples/ex_url$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_network_msg.o obj/n_time.o obj/n_thread_pool.o obj/n_hash.o obj/n_network.o $(REACTOR_OBJ) obj/n_base64.o $(NZLIB_OBJS) obj/n_lz4.o obj/lz4.o examples/ex_url.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(OPENSSL_CLIBS) $(EXE_LDFLAGS)

examples/ex_html$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_html.o examples/ex_html.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)

examples/ex_http2$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_http2.o examples/ex_http2.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)

examples/ex_hex$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_hex.o examples/ex_hex.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)

examples/ex_dns$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_dns.o examples/ex_dns.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)

# n_http3 links the HTTP/3 stack only when detected (HTTP3_CLIBS is empty otherwise,
# and n_http3.o is then the stub, so this example builds and runs in both modes).
examples/ex_http3$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_http3.o examples/ex_http3.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(HTTP3_CLIBS) $(EXE_LDFLAGS)

examples/ex_entropy$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_entropy.o examples/ex_entropy.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)

examples/ex_random$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_hex.o obj/n_random.o examples/ex_random.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)

examples/ex_cookies$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_cookies.o examples/ex_cookies.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)
...
examples/ex_network_connect_abort$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_network_msg.o obj/n_time.o obj/n_thread_pool.o obj/n_hash.o obj/n_network.o $(REACTOR_OBJ) obj/n_base64.o $(NZLIB_OBJS) obj/n_lz4.o obj/lz4.o examples/ex_network_connect_abort.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(OPENSSL_CLIBS) $(EXE_LDFLAGS)
...
examples/ex_gui$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_kvtable$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_kvtable.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_reentrant$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_reentrant.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)
...
examples/ex_gui_syntaxview$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_syntaxview.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_dropmenu$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_dropmenu.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_layout_persist$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_layout_persist.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_datagrid$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_datagrid.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_bench$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_bench.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_progressbar$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_progressbar.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_custom$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_custom.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_placeholder$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_placeholder.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_zorder$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_zorder.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_multiwin$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_multiwin.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_detach$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_detach.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_isometric$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o obj/n_iso_engine.o obj/n_astar.o obj/n_dead_reckoning.o obj/n_trajectory.o examples/ex_gui_isometric.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_dictionary$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o obj/n_particles.o obj/n_3d.o obj/n_allegro5.o obj/n_pcre.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_dictionary.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(PCRE_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_particles$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o obj/n_particles.o obj/n_3d.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_particles.o
	$(CC) $(CFLAGS) $(ALLEGRO_CFLAGS) -o $@ $^ $(CLIBS) $(ALLEGRO_CLIBS) $(EXE_LDFLAGS)

examples/ex_gui_network$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o obj/n_network.o $(REACTOR_OBJ) obj/n_network_msg.o obj/n_thread_pool.o obj/n_base64.o $(NZLIB_OBJS) obj/n_lz4.o obj/lz4.o examples/cJSON.o obj/n_clipboard.o obj/n_gui.o examples/ex_gui_network.o
...
examples/ex_pcre$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_pcre.o examples/ex_pcre.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(PCRE_CLIBS) $(EXE_LDFLAGS)

examples/ex_query$(EXT): obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_common.o obj/n_pcre.o obj/n_query.o examples/ex_query.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(PCRE_CLIBS) $(EXE_LDFLAGS)
...
examples/ex_json$(EXT): obj/n_common.o obj/n_log.o obj/n_list.o obj/n_hash.o obj/n_str.o obj/n_time.o obj/n_json.o examples/cJSON.o examples/ex_json.o
	$(CC) $(CFLAGS) -o $@ $^ $(CLIBS) $(EXE_LDFLAGS)
