...
SRC=n_common.c n_base64.c n_crypto.c n_config_file.c n_exceptions.c n_hash.c n_list.c n_log.c n_network.c n_network_msg.c n_nodup_log.c n_pcre.c n_stack.c n_str.c n_thread_pool.c n_time.c n_zlib.c n_user.c n_files.c
...
ifeq ($(HAVE_ALLEGRO),1) 
    ifeq ($(FORCE_NO_ALLEGRO),0)
        ...
        ALLEGRO_CFLAGS=-DALLEGRO_UNSTABLE
...
$(OUTPUT)$(LIB_DYN_EXT): $(OBJECTS)
	$(CC) ${LDFLAGS} -static-libgcc -static-libstdc++ -shared -o $(OUTPUT)$(LIB_DYN_EXT) $^ $(CLIBS) $(ALLEGRO_CLIBS) $(KAFKA_CLIBS)
...
examples/ex_gui$(EXT): obj/n_log.o obj/n_list.o obj/n_str.o obj/n_common.o obj/n_hash.o obj/n_time.o examples/ex_gui.o
