...
/* adapted from https://opensource.apple.com/source/QuickTimeStreamingServer/QuickTimeStreamingServer-452/CommonUtilitiesLib/base64.c */
...
int n_base64_decode_len( const char *bufcoded )
{
    int nbytesdecoded;
...
N_STR *n_base64_encode( N_STR *input )
{
    ...
    N_STR *encoded = new_nstr( n_base64_encode_len( input ) );
