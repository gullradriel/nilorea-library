...
void n_gui_print_token(N_GUI_TOKEN token) {
    switch (token.type) {
        case N_GUI_TOKEN_TAG_OPEN:    printf("N_GUI_TOKEN_TAG_OPEN: %s\n", token.value); break;
        case N_GUI_TOKEN_TAG_CLOSE:   printf("N_GUI_TOKEN_TAG_CLOSE: %s\n", token.value); break;
        case N_GUI_TOKEN_TAG_NAME:    printf("N_GUI_TOKEN_TAG_NAME: %s\n", token.value); break;
        case N_GUI_TOKEN_ATTR_NAME:   printf("N_GUI_TOKEN_ATTR_NAME: %s\n", token.value); break;
        case N_GUI_TOKEN_ATTR_VALUE:  printf("N_GUI_TOKEN_ATTR_VALUE: %s\n", token.value); break;
        case N_GUI_TOKEN_TEXT:        printf("N_GUI_TOKEN_TEXT: %s\n", token.value); break;
        case N_GUI_TOKEN_EOF:         printf("N_GUI_TOKEN_EOF\n"); break;
    }
}
