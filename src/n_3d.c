...
/**
 *@brief Update object position component.
 *@param object The object physics to update
 *@param it component of VECTOR3D to update. it values : 0 -> x, 1 -> y , 2 -> z
 *@param delta_t Elapsed time since last call for component update computing
...
/**
 *@brief Update object position component, reversed.
 *@param object The object physics to update
 *@param it component of VECTOR3D to update. it values : 0 -> x, 1 -> y , 2 -> z
 *@param delta_t Elapsed time since last call for component update computing
 *@return TRUE or FALSE
...
/**
 *@brief Update object position, reversed. Wrapper of update_physics_position_reverse_nb to update each component.
 *@param object The object physics to update
 *@param delta_t Elapsed time since last call for component update computing
 *@return TRUE or FALSE
 */
...
/**
 *@brief Update object position. Wrapper of update_physics_position_nb to update each component.
 *@param object The object physics to update
 *@param delta_t Elapsed time since last call for component update computing
 *@return TRUE or FALSE
 */
...
/**
 *@brief Quickly check if two values are the same sign or not
 *@param a first value
 ...
 *@param p2 Second point of vector 1
...
/**
 *@brief Compute angle between two VECTOR3D
 *@param vec1 first VECTOR3D
 *@param vec2 second VECTOR3D
