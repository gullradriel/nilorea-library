...
/* GIT_OID_SHA1_HEXSIZE was introduced in libgit2 1.4; older releases (e.g.
 * the 1.1 shipped by Debian 11) only expose the now-deprecated GIT_OID_HEXSZ.
 * Both denote the 40-char hex length of a SHA-1 oid. Alias so the code builds
 * against either. */
