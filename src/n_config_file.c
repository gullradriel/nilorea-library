...
/*!\fn size_t get_nb_config_file_sections( CONFIG_FILE *cfg_file , char *section_name )
...
/*!\fn size_t get_nb_config_file_sections_entries( CONFIG_FILE *cfg_file , char *section_name , size_t section_position , char *entry )
 *\brief Get the number of config file with section_name
 *\param cfg_file Config file to process
...
/*!\fn char *get_config_section_value( CONFIG_FILE *cfg_file , char *section_name , size_t section_position , char *entry , size_t entry_position )
