...
#define resize_nstr( __nstr , new_size ) \
	...
	/*! Macro to quickly allocate and sprintf to a new char */
#define strprintf( __n_var , ... ) \
	...
	/*! Macro to quickly allocate and sprintf to an nstr */
#define nstrprintf( __nstr_var , ... ) \
	...
	/*! Macro to quickly allocate and sprintf-cat to an nstr */
...
#include <inttypes.h>
	 ...
	 *\param __ptr A N_STR *object to free
